...
/isaac-sim/python.sh /isaac-sim/ur_ws/src/ur_bringup/isaac/common/ur16e_isaac_ros2.py          # GUI(환경/조명 포함)
...
python3 /isaac-sim/ur_ws/src/ur_bringup/isaac/common/moveit_plan_execute_demo.py   # -> RESULT: SUCCESS
```
...
python3 /isaac-sim/ur_ws/src/ur_bringup/isaac/ur16e_2f85/gripper_demo.py          # open/close → goals_ok=True
python3 /isaac-sim/ur_ws/src/ur_bringup/isaac/common/moveit_plan_execute_demo.py   # 팔 plan+execute → SUCCESS (그리퍼 collision 있어도 -10 안 남)
python3 /isaac-sim/ur_ws/src/ur_bringup/isaac/ur16e_2f85/selfcollision_demo.py   # 자기충돌 포즈 → MoveGroup REJECTED 실증
```
...
python3 /isaac-sim/ur_ws/src/ur_bringup/isaac/ur16e_2f85_d405/octomap_demo.py   # octomap 활성 plan+execute + probe
```
