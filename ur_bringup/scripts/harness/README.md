...
이전 데이터셋의 자세; `ready_v2` = 2026-09-16 URDF 가지(sim 스모크만); 2026-09-17 이후 수집은 `START_POSE=ready`(실측 랑데부, `HISTORY.md` §49.8), `groot_pipeline.sh` 는 자동). 3태스크 씬 수집은 `collect240.sh [N]`/`convert240.sh`
